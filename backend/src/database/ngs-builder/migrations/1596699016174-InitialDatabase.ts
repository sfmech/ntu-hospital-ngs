...
export class InitialDatabase1596699016174 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "segments" ("segment_id" SERIAL NOT NULL, "sample_id"  SERIAL NOT NULL, "chr" character varying NOT NULL, "position" character varying NOT NULL, "dbSNP" character varying, "freq" integer, "depth" integer, "annotation" character varying, "gene_name" character varying, "HGVS.p" character varying NOT NULL, "HGVS.c" character varying NOT NULL, "clinical_significance" character varying, "global_AF" integer, "AFR_AF" integer, "AMR_AF" integer, "EUR_AF" integer, "ASN_AF" integer, CONSTRAINT "segments_pkey" PRIMARY KEY ("segment_id"), CONSTRAINT "foreign_sample" FOREIGN KEY ("sample_id") REFERENCES public.samples (sample_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE)`);
