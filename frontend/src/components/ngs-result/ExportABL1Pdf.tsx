...
export const MyDocumentABL1: FunctionComponent<ExportPdfProps> = (prop) => (
	<Document>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.containView}>
				...
				<View style={styles.containInfoView}>
					<Text style={{ width: 350, fontFamily: 'KAIU' }}>檢測項目 : ABL1 mutation screening for malignancies</Text>
				</View>
