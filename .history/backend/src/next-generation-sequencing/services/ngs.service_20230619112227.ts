...
export class NGSService {
	...
	async getFilelist(): Promise<{}> {
		...
		return { Myeloid: { analysis: Myeloidstatus, files: Myeloidresponse }, MPN: { analysis: MPNstatus, files: MPNresponse }, ABL1: { analysis: ABL1status, files: ABL1response }, TP53: { analysis: TP53status, files: TP53response } };
	}
